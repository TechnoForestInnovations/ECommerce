...
# Models
# -------------------------------
from .models import Subscriber, CartItem,TaxesAndCharges
...
def cart(request):
    ...
    """
    all_items_eligible_for_cod = True  # boolean variable
    ...
    # Calculate subtotal for each item and check COD eligibility
